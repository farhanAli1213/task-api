...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  console.log(otp);
  // creatSendToken(newUser, 200, "user created", res, req.body.device);
  res.status(200).json({
    status: 200,
    success: true,
    message: "User has created, otp has been sent to your email!",
    data: { user: newUser },
  });
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  creatSendToken(user, 200, "OTP sent to your email", res, req.body.device);
});
